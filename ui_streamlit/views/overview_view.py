...
def _render_system_analytics_and_maintenance_ui():
    """
    Renders visual UI for System Analytics & GitHub Maintenance History.
    Accessible immediately on app launch without needing a loaded corpus.
    """
...
def render_overview():
    ...
    # Always render system analytics and maintenance history at the top
    _render_system_analytics_and_maintenance_ui()
